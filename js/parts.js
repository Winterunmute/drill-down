...
DrillDown.CHASSIS = {
  scrap_frame: {
    id: 'scrap_frame', name: 'Scrap Frame', rows: 5, cols: 6, cost: 0,
    stats: {}, mods: {},
    color: '#d4a574',
    desc: 'Standard-issue starter frame. No innate stats, no zone cells — a blank slate.'
  },
  venting_lattice: {
    id: 'venting_lattice', name: 'Venting Lattice', rows: 5, cols: 6, cost: 200,
    stats: { cooling: 3 },
    mods: { '0,0': 'vented', '0,5': 'vented', '4,0': 'vented', '4,5': 'vented' },
    color: '#74b9ff',
    desc: 'Heat-dump frame for hot drill builds — innate cooling plus vented corner cells.'
  },
  drill_platform: {
    id: 'drill_platform', name: 'Drill Platform', rows: 5, cols: 6, cost: 250,
    stats: { drillPower: 3, heatGen: 2 },
    mods: { '0,1': 'conductive', '1,1': 'conductive', '2,1': 'conductive', '3,1': 'conductive', '4,1': 'conductive' },
    color: '#e67e22',
    desc: 'Power-feed spine down one column boosts drills placed along it. Runs a little hot.'
  },
  slipstream: {
    id: 'slipstream', name: 'Slipstream', rows: 4, cols: 8, cost: 280,
    stats: { speed: 0.5 },
    mods: { '0,7': 'sensor', '1,7': 'sensor', '2,7': 'sensor', '3,7': 'sensor' },
    color: '#dfe6e9',
    desc: 'Slim scout hull — fewer slots, innate speed, sensor nodes in the nose. Built for fast shallow-loot runs.'
  },
  hauler_barge: {
    id: 'hauler_barge', name: 'Hauler Barge', rows: 5, cols: 7, cost: 300,
    stats: { cargo: 6, speed: -0.1 },
    mods: { '4,1': 'cargo_bay', '4,2': 'cargo_bay', '4,3': 'cargo_bay', '4,4': 'cargo_bay', '4,5': 'cargo_bay' },
    color: '#55efc4',
    desc: 'Wide freight frame with a cargo-bay keel. Heavy — drags on speed.'
  },
  bastion: {
    id: 'bastion', name: 'Bastion', rows: 6, cols: 5, cost: 320,
    stats: { hp: 15, speed: -0.2 },
    mods: { '0,0': 'reinforced', '0,4': 'reinforced', '5,0': 'reinforced', '5,4': 'reinforced' },
    color: '#a0a0a0',
    desc: 'Tall armored tower — innate HP and reinforced corners. Slow but very hard to kill.'
  },
  surveyor_web: {
    id: 'surveyor_web', name: 'Surveyor Web', rows: 6, cols: 6, cost: 500, requires: 75,
    stats: { detect: 10 },
    mods: { '0,0': 'sensor', '1,1': 'sensor', '2,2': 'sensor', '3,3': 'sensor', '4,4': 'sensor', '5,5': 'sensor' },
    color: '#a29bfe',
    desc: 'Prospector frame — a diagonal lattice of sensor nodes threads detect through the whole build.'
  },
  reactor_cradle: {
    id: 'reactor_cradle', name: 'Reactor Cradle', rows: 6, cols: 6, cost: 650, requires: 150,
    stats: { heatGen: 2 },
    mods: { '2,2': 'amplified', '2,3': 'amplified', '3,2': 'amplified', '3,3': 'amplified' },
    color: '#ffb000',
    desc: 'An amplified 2×2 heart — park your best parts dead center. The field bleeds a little heat.'
  },
  leviathan_hull: {
    id: 'leviathan_hull', name: 'Leviathan Hull', rows: 6, cols: 7, cost: 900, requires: 150,
    stats: { hp: 20, cargo: 5, speed: -0.3 },
    mods: { '1,3': 'unstable', '2,3': 'unstable', '3,3': 'unstable', '4,3': 'unstable' },
    color: '#636e72',
    desc: 'A salvaged deep-hauler: huge, tough, roomy — but its cracked core column destabilizes anything placed over it.'
  },
  hammerhead: {
    id: 'hammerhead', name: 'Hammerhead', rows: 6, cols: 7, cost: 350, requires: 25,
    mask: [
      'XXXXXXX',
      '.XXXXX.',
      '..XXX..',
    ...
    mods: { '0,0': 'sensor', '0,6': 'sensor', '2,3': 'conductive', '3,3': 'conductive', '4,3': 'conductive', '5,3': 'conductive' },
    color: '#f39c12',
    desc: 'T-shaped prospector hull — a wide sensor head over a powered drill spine. Awkward to pack, deadly straight down.'
  },
  star_fort: {
    id: 'star_fort', name: 'Star Fort', rows: 7, cols: 7, cost: 800, requires: 150,
    mask: [
      '.XXXXX.',
      'XXXXXXX',
      'XXXXXXX',
    ...
    mods: { '0,2': 'reinforced', '0,4': 'reinforced', '2,0': 'reinforced', '2,6': 'reinforced', '4,0': 'reinforced', '4,6': 'reinforced', '6,2': 'reinforced', '6,4': 'reinforced', '2,3': 'amplified', '3,2': 'amplified', '3,3': 'amplified', '3,4': 'amplified', '4,3': 'amplified' },
    color: '#00b894',
    desc: 'A cut-corner bastion — reinforced bulwarks at every point and an amplified keep at its heart.'
  },
  scorpion: {
    id: 'scorpion', name: 'Scorpion', rows: 6, cols: 8, cost: 1100, requires: 200,
    mask: [
      'XXX..XXX',
      'XXXXXXXX',
      '.XXXXXX.',
    ...
    mods: { '0,0': 'reinforced', '0,7': 'reinforced', '5,6': 'conductive', '5,7': 'amplified' },
    color: '#e74c3c',
    desc: 'Segmented predator hull — armored claws, a quick body, and an amplified stinger at the tail tip.'
  },
  singularity_lattice: {
    id: 'singularity_lattice', name: 'Singularity Lattice', rows: 7, cols: 7, cost: 1500, requires: 300,
    stats: { heatGen: 4 },
    mods: {
      '3,3': 'amplified', '2,3': 'amplified', '4,3': 'amplified', '3,2': 'amplified', '3,4': 'amplified',
      '3,5': 'amplified', '5,3': 'amplified',
      '0,0': 'unstable', '0,6': 'unstable', '6,0': 'unstable', '6,6': 'unstable'
    },
    color: '#8854d0',
